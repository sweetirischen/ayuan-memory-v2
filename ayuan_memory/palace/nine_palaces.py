...
class NinePalaces:
    ...
    def classify_text(self, text: str) -> int:
        ...
        keywords_to_palace = {
            # 坎宫·起源
            1: ["起源", "种子", "开始", "混沌", "初始", "创意", "想法"],
            # 坤宫·承载
            2: ["基础", "规则", "法律", "政策", "框架", "承载", "地基"],
            # 震宫·生发
            3: ["成长", "系统", "技术", "开发", "生发", "建设", "代码"],
            # 巽宫·运化
            4: ["平台", "传播", "运营", "趋势", "运化", "推广", "分发"],
            # 中宫·核心
            5: ["核心", "决策", "枢纽", "中心", "关键", "重要"],
            # 乾宫·收敛
            6: ["战略", "投资", "管理", "秩序", "收敛", "企业"],
            # 兑宫·显现
            7: ["内容", "创作", "表达", "显现", "发布", "自媒体"],
            # 艮宫·存储
            8: ["存储", "归档", "记忆", "资源", "沉淀", "知识库"],
            # 离宫·升华
            9: ["智慧", "升华", "哲学", "洞察", "最高", "道"],
        }
        
        for palace, keywords in keywords_to_palace.items():
